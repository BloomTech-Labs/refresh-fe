...
const MissionStats = () => {
  ...
  useEffect(() => {
    axiosWithAuth()
      .get(`/answers/datefilter?startDate=${start}&endDate=${end}`)
      ...
      <StatsView>
        <StatsWrapper>
          <StatsContainer>
            ...
            <MissionSubHeading>
              <p>
                Drinking at least glasses of water is recommended to prevent
                dehydration
              </p>
            </MissionSubHeading>

            <DummyStats>Mission stats coming soon!</DummyStats>

            <MissionStreak>
              Your best streak for this mission is
              <br /> <span>25 days</span>
            </MissionStreak>
